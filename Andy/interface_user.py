...
stock_code = st.selectbox("Select Stock Code:", ["2609", "0050", "0052", "0053", "0054"])  # Add other stock codes as needed
...
# Set the title of the app
st.subheader("Select a Duration (Year and Month)")
...
if start_year and start_month and end_year and end_month:
        ...
        # Streamlit code to display the table
        ...
        # Apply CSS styling to extend the table to full width
        # Center the table
